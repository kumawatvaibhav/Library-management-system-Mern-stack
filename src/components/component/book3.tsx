...
* @see https://v0.dev/t/t8T1HrOIWXU
        ...
        <section className="bg-muted py-12 md:py-20 lg:py-28">
          <div className="container px-4 md:px-6">
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">About the Library</h2>
                <p className="mt-4 text-muted-foreground md:text-xl">
                  The Public Library has been serving the community for over 50 years, providing access to a vast
                  collection of books, resources, and educational programs. Our knowledgeable librarians are always
                  available to assist you in finding your next great read.
                </p>
        ...
        <section className="py-12 md:py-20 lg:py-28">
          <div className="container px-4 md:px-6">
            <div className="mb-8 text-center">
              ...
              <p className="mt-4 text-muted-foreground md:text-xl">Check out our upcoming events and programs.</p>
            </div>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
              <Card>
                <CardContent>
                  <h3 className="text-lg font-semibold">Author Talk: Jane Doe</h3>
                  <p className="mt-2 text-muted-foreground">
                    Join us for a discussion with bestselling author Jane Doe as she discusses her latest book.
                  </p>
                  <div className="mt-4 flex items-center gap-2">
                    <CalendarDaysIcon className="h-4 w-4" />
                    <p className="text-muted-foreground">June 15, 2024 - 7:00 PM</p>
                  </div>
                  <div className="mt-2 flex items-center gap-2">
                    <LocateIcon className="h-4 w-4" />
                    <p className="text-muted-foreground">Main Library Auditorium</p>
                  </div>
                </CardContent>
                <CardFooter>
              ...
              <Card>
                <CardContent>
                  <h3 className="text-lg font-semibold">Book Club Meeting</h3>
                  <p className="mt-2 text-muted-foreground">
                    Join our monthly book club discussion. This month's book is "The Kite Runner" by Khaled Hosseini.
                  </p>
                  <div className="mt-4 flex items-center gap-2">
                    <CalendarDaysIcon className="h-4 w-4" />
                    <p className="text-muted-foreground">July 20, 2024 - 6:30 PM</p>
                  </div>
                  <div className="mt-2 flex items-center gap-2">
                    <LocateIcon className="h-4 w-4" />
                    <p className="text-muted-foreground">Main Library Community Room</p>
                  </div>
                </CardContent>
                <CardFooter>
                  <Button>RSVP</Button>
